...
function Header2() {
  return (
    <>
      <header className="flex md:pl-0 fixed mt-0 pt-0 top-0 w-full bg-[#292929E6] lg:hidden justify-between items-center z-[9999]">
        <a href="/">
          <img
            alt="logo"
            loading="lazy"
        ...
        <nav className="">
          <div className="">
            <button
              type="button"
              className="relative invisible flex-row items-center right-0 justify-center p-2 h-16 w-36 text-sm text-black focus:outline-none bg-white py-2 px-5"
            >
